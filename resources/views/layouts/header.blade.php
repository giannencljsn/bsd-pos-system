    ...
    <li class="c-header-nav-item dropdown">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
            ...
            <div class="d-flex flex-column">
                ...
                <span class="font-italic" id="status">Online <i class="bi bi-circle-fill text-success"
...
<script>
    ...
    // Update the UI based on navigator.onLine
    ...
    // Extra network check to confirm connection by fetching a resource
